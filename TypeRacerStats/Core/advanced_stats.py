...
class AdvancedStats(commands.Cog):
    ...
    async def top(self, ctx, *args):
        ...
        formatted_category = {'pts': 'points',
                              'wpm': 'WPM', 'weightedwpm': 'WPM'}[category]
    ...
    async def racedetails(self, ctx, *args):
        ...
        try:
            ...
            try:
                time_spent += 12 * \
                    texts_length[text_id]['length'] / first_race[3]
            except ZeroDivisionError:
                races -= 1
                pass
            if first_race[4] == 0:
                retro += first_race[3] / 60 * \
                    texts_length[text_id]['word count']
            else:
